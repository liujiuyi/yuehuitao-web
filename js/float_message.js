Ext.example = function() {
	...
	return {
		...
		init : function() {
			/*
			 * var t = Ext.get('exttheme'); if(!t){ // run locally? return; }
			 * var theme = Cookies.get('exttheme') || 'aero'; if(theme){
			 * t.dom.value = theme; Ext.getBody().addClass('x-'+theme); }
			 * t.on('change', function(){ Cookies.set('exttheme', t.getValue());
